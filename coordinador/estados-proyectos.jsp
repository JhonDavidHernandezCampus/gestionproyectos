...
<head>
    ...
    <title>Estados de Proyectos</title>
...
<div class="container mt-5">
    <h3 class="mb-4">Estados de Proyectos</h3>
    <a href="./agregarPro.jsp" class="btn btn-primary mb-3">Agregar Proyecto</a>
        ...
        <tbody>
            ...
            <c:forEach var="proyecto" items="${proyectos.rows}">
                <tr>
                    ...
                    <td><span class="badge bg-<c:choose><c:when test="${proyecto.estado_estudiante == 'pendiente'}">warning</c:when><c:when test="${proyecto.estado_estudiante == 'aprobado'}">success</c:when><c:when test="${proyecto.estado_estudiante == 'rechazado'}">danger</c:when></c:choose>">${proyecto.estado_estudiante}</span></td>
