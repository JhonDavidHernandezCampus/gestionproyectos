    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="./proyectos-director.jsp">Proyectos Director</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./aprovar-proyecto.jsp">Aprobar Proyectos</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body text-center">
                    <img src="./../img/check.png"  width="100px" height="120px"/>
                    <h5 class="card-title">Proyectos aprovados por director</h5>
                    <a href="./proyectos-director.jsp" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body text-center">
                    <img src="./../img/check.png"  width="100px" height="120px"/>
                    <h5 class="card-title">Aprobar Proyectos</h5>
                    <a href="./aprovar-proyecto.jsp" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
    </div>
