        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">Información Alumnos</h5>
                    <p class="card-text">Aquí puedes ver la información relevante de los alumnos.</p>
                    <a href="./info-estudiantes.jsp" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">Aquí puedes aprobar los proyectos presentados por los estudiantes.</p>
